...
<article id="post-original" <?php post_class(); ?> style="background-image: url(<?php echo $background;?>);">
	<h2 class="entry-title-original"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
	<?php if ( is_search() ) : // Only display Excerpts for Search ?>
	<div class="entry-summary-original">
		<?php the_excerpt(); ?>
