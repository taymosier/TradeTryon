...
<!-- Add to header if you want to include a banner article -->

<?php $my_query = new WP_Query('category_name=banner&&showposts=1'); ?>
...
<article id="banner" <?php post_class(); ?> >
	<img src="<?php echo $background;?>") />
	<h2 class="entry-title-banner"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
	<?php if ( is_search() ) : // Only display Excerpts for Search ?>
	<div class="entry-summary-banner">
		<?php the_excerpt(); ?>
